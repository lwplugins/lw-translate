 ...
 * so the success path -- where the actual sanitization in the private
 * save_options() runs (tone whitelist, cache_ttl absint, locale passthrough)
 * -- cannot be exercised through the public API without terminating the
...
use LightweightPlugins\Translate\Admin\SettingsSaver;
use LightweightPlugins\Translate\Tests\Unit\MonkeyTestCase;

/**
 * @covers \LightweightPlugins\Translate\Admin\SettingsSaver
 */
final class SettingsSaverTest extends MonkeyTestCase {
	...
	public function test_does_nothing_when_the_user_lacks_manage_options(): void {
		$_POST = [
			'lw_translate_save'   => '1',
			'_lw_translate_nonce' => 'good-nonce',
		];
